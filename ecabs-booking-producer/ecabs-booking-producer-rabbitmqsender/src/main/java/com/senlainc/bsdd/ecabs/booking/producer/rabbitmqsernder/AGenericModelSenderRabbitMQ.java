...
public abstract class AGenericModelSenderRabbitMQ<K extends Serializable, T extends AEntityDto<K>>
    ...
    protected AGenericModelSenderRabbitMQ(Class<T> clazz, String exchange) {
        this.clazz = clazz;
